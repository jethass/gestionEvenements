...
use Omea\GestionTelco\EvenementsBundle\Validator\Constraint\IsValidMSISDN;
use Omea\GestionTelco\EvenementsBundle\Validator\Constraint\IsValidMSISDNValidator;
