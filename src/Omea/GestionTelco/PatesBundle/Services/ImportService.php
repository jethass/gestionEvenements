...
use Omea\Domain\Main\StockImei;
...
class ImportService
{
    ...
    {
        $article = $this->emMain->getRepository('Omea\Domain\Main\Article')->find(556000);
        ...
        foreach ($rows as $row) {
            try {
                ...
                $stockImei = $this->emMain->getRepository('Omea\Domain\Main\StockImei')->find($row[0]);
