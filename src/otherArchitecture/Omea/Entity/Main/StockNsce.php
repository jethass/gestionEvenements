...
class StockNsce
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Omea\Entity\Main\EtatStock")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Omea\Entity\Main\EtatEntite")
     ...
     * @return StockNsce
     */
    public function setEtatStock(EtatStock $etatStock = null)
    {
     ...
     * @return StockNsce
     */
    public function setEtatEntite(EtatEntite $etatEntite = null)
    {
