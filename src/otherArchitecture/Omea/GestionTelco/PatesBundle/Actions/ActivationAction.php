...
class ActivationAction extends AbstractAction implements ActionInterface
{
    public function generateRequest(FemtoProvisioningMonitoring $fpm)
    {
        ...
        $stockMsisdn = $this->emMain->getRepository('Omea\Entity\Main\StockMsisdn')->find($fpm->getMsisdn());
        ...
        $client = $this->emMain
            ->getRepository('Omea\Entity\Main\Client')
        ...
        $localite = $this->emHexavia
            ->getRepository('Omea\Entity\Hexavia\Localite')
